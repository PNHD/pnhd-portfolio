// ============================================================
// NOVA UI KIT â€” Part 2: Components
...
(async () => {
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    for (const [sn, sc] of Object.entries(sizes)) {
      for (const [st, stc] of Object.entries(states)) {
        ...
        if (st === "Focus") input.effects = [{ type: "DROP_SHADOW", color: { r: 0.39, g: 0.4, b: 0.95, a: 0.15 }, offset: { x: 0, y: 0 }, radius: 3, visible: true, blendMode: "NORMAL" }];
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    for (const sz of ["SM", "MD"]) {
      for (const st of ["Off", "On", "Disabled Off", "Disabled On"]) {
        ...
        thumb.effects = [{ type: "DROP_SHADOW", color: { r: 0, g: 0, b: 0, a: 0.1 }, offset: { x: 0, y: 1 }, radius: 3, visible: true, blendMode: "NORMAL" }];
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    comp.fills = [{ type: "SOLID", color: hex("#FFFFFF") }];
    comp.effects = [
      { type: "DROP_SHADOW", color: { r: 0, g: 0, b: 0, a: 0.1 }, offset: { x: 0, y: 20 }, radius: 25, visible: true },
      { type: "DROP_SHADOW", color: { r: 0, g: 0, b: 0, a: 0.04 }, offset: { x: 0, y: 8 }, radius: 10, visible: true },
    ];
  ...
  figma.closePlugin(`âœ… Components created: Button, Input, Badge, Avatar, Toggle, Checkbox, Stat Card, Table Row, Nav Item, Select, Toast, Modal, Tab, Progress â€” at y=0 to ${yOffset}`);
})();
